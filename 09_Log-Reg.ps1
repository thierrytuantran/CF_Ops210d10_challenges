...
Get-WinEvent -LogName System | Where-Object { $_.TimeCreated -ge (Get-Date).AddHours(-24) } | Out-File -FilePath "$env:USERPROFILE\Desktop\last_24.txt"

# Output all "error" type events from the System event log to a file on your desktop named errors.txt.
Get-WinEvent -LogName System | Where-Object { $_.Level -eq 2 } | Out-File -FilePath "$env:USERPROFILE\Desktop\errors.txt"
